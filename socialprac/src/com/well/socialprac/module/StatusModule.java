...
//	}
	...
	@At
	public String save(PracticeStatus practiceStatus,HttpServletResponse response,HttpSession session) throws Exception{
...
//		response.sendRedirect("list");
	...
	@At
	@Ok("jsp:jsp.")
	public List<PracticeStatus> list(Pager pager){
